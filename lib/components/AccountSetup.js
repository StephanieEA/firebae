...
const AccountSetup = (props) => {
  const { keys, updateMonthly, user, itemValue, budgetItem,
   submission, updateValue, updateTime } = props;
      ...
      <section className='account-setup'>
          ...
          <Button
            ...
            text='Submit'/>
             ...
             <p><Link to='/budgets' aria-label='click here'><div className='burns-sign-2'></div></Link></p>
      </section>
  )
}
