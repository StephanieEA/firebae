...
export default class Application extends Component {
  ...
  submission(e) {
    firebase.database().ref(this.state.user.uid).push({ user: pick(this.state.user, 'displayName', 'email', 'uid', 'photoURL'),
      monthlyIncome: this.state.draftMonthly,
      budgets: extend(this.state.budgetObjectArray),
      test: 'test',
      createdAt: Date.now(),
    })
  }
