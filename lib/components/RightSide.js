...
/>
{(monthlyIncomes-itemTotal < 0) && <p className='broken-pie-message'>Wow. You are so broke that you literally broke our pie chart. Try not spend any more this month!</p> }
</section>)
  }
}
